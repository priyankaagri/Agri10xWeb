...
public class RecyclerAdapterAccuWeather$RecyclerViewHolder_ViewBinding implements Unbinder {
  private RecyclerAdapterAccuWeather.RecyclerViewHolder target;

  @UiThread
  public RecyclerAdapterAccuWeather$RecyclerViewHolder_ViewBinding(
      RecyclerAdapterAccuWeather.RecyclerViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerAdapterAccuWeather.RecyclerViewHolder target = this.target;
