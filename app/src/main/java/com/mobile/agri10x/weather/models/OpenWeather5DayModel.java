package com.mobile.agri10x.weather.models;
...
public class OpenWeather5DayModel {
    ...
    public HashMap<String, ArrayList<Main>> getMinMaxTemp() throws ParseException {
     ...
     private HashMap<String, ArrayList<Main>> getDateWise(ArrayList<List> arrayList) throws ParseException {
        ArrayList<Double> arrayListTemp;
        HashMap<String, ArrayList<Main>> tempListDateWise = new HashMap<>();
        ArrayList<Main> arrayList1 = new ArrayList<>();
        ArrayList<Main> arrayList2 = new ArrayList<>();
