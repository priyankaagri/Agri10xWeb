...
import com.mobile.agri10x.weather.utils.ApiService;
...
public class AutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    private final List<LocationSearchModel> mResultList = new ArrayList<>();
    private final String BASE_URL_ACCU_WEATHER = "http://api.accuweather.com/";
    private final Context mContext;
    private final String ACCU_WEATHER_APP_ID;
