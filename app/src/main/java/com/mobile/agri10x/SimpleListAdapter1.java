...
public class SimpleListAdapter1 extends BaseAdapter implements Filterable, ISpinnerSelectedView {

    private Context mContext;
    private ArrayList<String> mBackupStrings;
    private ArrayList<String> mStrings;
    private SimpleListAdapter1.StringFilter mStringFilter = new SimpleListAdapter1.StringFilter();

    public SimpleListAdapter1(Context context, ArrayList<String> strings) {
        mContext = context;
        mStrings = strings;
